...
function Signup() {
  ...
  const [username, setUsername] = useState(""); // To save the name
  const [phone, setPhone] = useState(""); // To save the phone
  const [email, setEmail] = useState(""); // To save the email
  const [password, setPassword] = useState(""); // To save the password
